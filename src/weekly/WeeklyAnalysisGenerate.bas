...
Private Sub AddGeographyEntryVariant( _
    ByVal TargetEntries As Object, _
    ByVal TargetName As String, _
    ByVal NameVariant As String)
    ...
    If EntryKey = "" Then Exit Sub
    If Not TargetEntries.Exists(EntryKey) Then Exit Sub

    Set Entry = TargetEntries(EntryKey)
    Entry("Variants") = _
        AppendUniqueGeographyVariant( _
            CStr(Entry("Variants")), _
            NameVariant)
...
Private Function CanonicalizeExposureDictionary( _
    ByVal RawExposure As Object, _
    ByVal CanonicalNameMap As Object) As Object

    Dim CanonicalExposure As Object
    Dim RawName As Variant
    Dim CanonicalName As String

    Set CanonicalExposure = NewExposureDictionary()

    If Not RawExposure Is Nothing Then

        For Each RawName In RawExposure.Keys
            ...
            AddExposure _
                CanonicalExposure, _
                CanonicalName, _
                CDbl(RawExposure(RawName))

        Next RawName

    End If

    Set CanonicalizeExposureDictionary = CanonicalExposure

End Function

Private Function CanonicalizeExposureNDGDictionary( _
    ByVal RawExposureNDGs As Object, _
    ByVal CanonicalNameMap As Object) As Object

    Dim CanonicalExposureNDGs As Object
    Dim RawName As Variant
    Dim CanonicalName As String

    Set CanonicalExposureNDGs = NewExposureNDGDictionary()

    If Not RawExposureNDGs Is Nothing Then

        For Each RawName In RawExposureNDGs.Keys
    ...
    Set CanonicalizeExposureNDGDictionary = _
        CanonicalExposureNDGs
...
Private Sub AddCertificateExposure( _
    ...
    For Each Underlying In Underlyings
        ...
        ComponentValue = _
            PositionValue * CDbl(Component("Weight"))
...
Private Function FindWorksheetHeaderColumn( _
    ByVal ws As Worksheet, _
    ...
    For ColumnNo = 1 To LastColumn
        ...
        If NormalizeHeader( _
           ...
           NormalizeHeader(HeaderName) Then
            ...
            FindWorksheetHeaderColumn = ColumnNo
...
Private Sub AddExposureByCompanyDimension( _
    ByVal SourceExposure As Object, _
    ByVal DimensionExposure As Object, _
    ...
    If DimensionExposure Is Nothing Then Exit Sub
...
Private Function CanonicalizeExposureUsingCompanies( _
    ByVal RawExposure As Object, _
    ByVal CompaniesByName As Object, _
    ByVal CompaniesByVariant As Object) As Object
    ...
    If Not RawExposure Is Nothing Then
        ...
        For Each ExposureName In RawExposure.Keys

            CanonicalName = CStr(ExposureName)
            ...
            AddExposure _
                CanonicalExposure, _
                CanonicalName, _
                CDbl(RawExposure(ExposureName))

        Next ExposureName

    End If

    Set CanonicalizeExposureUsingCompanies = _
        CanonicalExposure

End Function

Private Function CanonicalizeExposureNDGsUsingCompanies( _
    ByVal RawExposureNDGs As Object, _
    ByVal CompaniesByName As Object, _
    ByVal CompaniesByVariant As Object) As Object
    ...
    If Not RawExposureNDGs Is Nothing Then
        ...
        For Each ExposureName In RawExposureNDGs.Keys
    ...
    Set CanonicalizeExposureNDGsUsingCompanies = _
        CanonicalExposureNDGs
...
Private Function BuildCombinedExposureDictionary( _
    ByVal FirstExposure As Object, _
    ByVal SecondExposure As Object, _
    ByVal ThirdExposure As Object, _
    ByVal FourthExposure As Object, _
    ByVal FifthExposure As Object) As Object

    Dim CombinedExposure As Object

    Set CombinedExposure = NewExposureDictionary()

    AddExposureDictionary FirstExposure, CombinedExposure
    AddExposureDictionary SecondExposure, CombinedExposure
    AddExposureDictionary ThirdExposure, CombinedExposure
    AddExposureDictionary FourthExposure, CombinedExposure
    AddExposureDictionary FifthExposure, CombinedExposure

    Set BuildCombinedExposureDictionary = CombinedExposure

End Function

Private Function BuildCombinedExposureNDGDictionary( _
    ByVal FirstExposureNDGs As Object, _
    ByVal SecondExposureNDGs As Object, _
    ByVal ThirdExposureNDGs As Object, _
    ByVal FourthExposureNDGs As Object, _
    ByVal FifthExposureNDGs As Object) As Object

    Dim CombinedExposureNDGs As Object

    Set CombinedExposureNDGs = NewExposureNDGDictionary()

    AddExposureNDGDictionary _
        FirstExposureNDGs, CombinedExposureNDGs

    AddExposureNDGDictionary _
        SecondExposureNDGs, CombinedExposureNDGs

    AddExposureNDGDictionary _
        ThirdExposureNDGs, CombinedExposureNDGs

    AddExposureNDGDictionary _
        FourthExposureNDGs, CombinedExposureNDGs

    AddExposureNDGDictionary _
        FifthExposureNDGs, CombinedExposureNDGs

    Set BuildCombinedExposureNDGDictionary = _
        CombinedExposureNDGs

End Function

Private Function MapExposureNamesForOutput( _
    ByVal SourceExposure As Object, _
    ByVal NameMap As Object) As Object

    Dim MappedExposure As Object
    Dim ExposureName As Variant
    Dim DisplayName As String
    Dim MappedName As String

    Set MappedExposure = NewExposureDictionary()

    If SourceExposure Is Nothing Then

        Set MapExposureNamesForOutput = MappedExposure
    ...
    For Each ExposureName In SourceExposure.Keys
        ...
        DisplayName = CStr(ExposureName)
        MappedName = ResolveExactName(DisplayName, NameMap)

        If MappedName <> "" Then DisplayName = MappedName
...
Private Function MapExposureNDGNamesForOutput( _
    ByVal SourceExposureNDGs As Object, _
    ByVal NameMap As Object) As Object

    Dim MappedExposureNDGs As Object
    Dim ExposureName As Variant
    Dim DisplayName As String
    Dim MappedName As String

    Set MappedExposureNDGs = NewExposureNDGDictionary()

    If SourceExposureNDGs Is Nothing Then

        Set MapExposureNDGNamesForOutput = _
            MappedExposureNDGs
    ...
    For Each ExposureName In SourceExposureNDGs.Keys
        ...
        MergeExposureNDGSet _
            SourceExposureNDGs, _
            CStr(ExposureName), _
            MappedExposureNDGs, _
            DisplayName

    Next ExposureName

    Set MapExposureNDGNamesForOutput = MappedExposureNDGs

End Function

Private Function BuildSingleCompanyDimensionExposure( _
    ByVal DimensionName As String, _
    ByVal SourceExposure As Object, _
    ByVal CompaniesByName As Object, _
    ByVal CompaniesByVariant As Object) As Object

    Dim DimensionExposure As Object

    Set DimensionExposure = NewExposureDictionary()

    AddExposureByCompanyDimension _
        SourceExposure, _
        DimensionExposure, _
        DimensionName, _
        CompaniesByName, _
    ...
    Set BuildSingleCompanyDimensionExposure = _
        DimensionExposure

End Function

Private Function BuildSingleCompanyDimensionNDGs( _
    ByVal DimensionName As String, _
    ByVal SourceExposureNDGs As Object, _
    ByVal CompaniesByName As Object, _
    ByVal CompaniesByVariant As Object) As Object

    Dim DimensionNDGs As Object
    Dim ExposureName As Variant
    Dim CompanyEntry As Object
    Dim DimensionValue As String

    Set DimensionNDGs = NewExposureNDGDictionary()

    If Not SourceExposureNDGs Is Nothing Then
    ...
    Set BuildSingleCompanyDimensionNDGs = DimensionNDGs
