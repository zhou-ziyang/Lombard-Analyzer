...
snapshot's rows in the overview, the breakdown and the two movement tables
are highlighted, a pale rose (#FAE2E0) under black. The overview and the two movement tables stack in the
